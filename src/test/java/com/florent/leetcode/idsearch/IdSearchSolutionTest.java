...
public class IdSearchSolutionTest {
    ...
    private IdSearchSolution solution;

    @BeforeEach
    void setup() {
        solution = new IdSearchSolution();
    }
    ...
    class SearchId {
        ...
        void shouldFindCustomerId() {
            var result = solution.searchId(CUSTOMERS, 4117);
        ...
        void shouldNotFindCustomerId() {
            var result = solution.searchId(CUSTOMERS, 123456789L);
    ...
    class SearchIdPerformance {
        ...
        void shouldFindCustomerIdForVeryLargeArray() {
            ...
            var result = solution.searchId(largeArray, existingCustomerId);
            assertThat(result).isTrue();
        }
        ...
        void shouldNotFindCustomerIdForVeryLargeArray() {
            ...
            var result = solution.searchId(largeArray, nonExistingCustomerId);
            assertThat(result).isFalse();
        }
